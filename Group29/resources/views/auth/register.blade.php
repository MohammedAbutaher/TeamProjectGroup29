                        ...
                        <div class="form_space">
                            <div class="input_form">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" placeholder="Mike Smith" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
